    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-line">
        ...
        <div class="p-5 space-y-2">
            ...
            @foreach([
                ...
                ['Aset Lancar Lainnya', $analisa->other_current_asset],
                ['Total Aset Lancar', $analisa->current_asset, true],
                ['Aset Tetap', $analisa->fixed_asset],
                ['Aset Tidak Lancar Lainnya', $analisa->other_non_current_asset],
        ...
        <div class="p-5 space-y-2">
            ...
            @foreach([
                ['Utang Usaha', $analisa->account_payable],
                ['Pinjaman Jangka Pendek', $analisa->short_term_loans],
...
<div class="bg-white rounded-xl border border-line overflow-hidden">
    ...
    <div class="p-5 space-y-2">
        @foreach([
            ...
            ['Beban Pokok Penjualan', $analisa->cost_of_good_sold],
