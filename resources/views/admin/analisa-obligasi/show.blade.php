...
<div class="space-y-6" x-data="{
    ...
    <div class="flex items-start justify-between flex-wrap gap-4">
        <div>
            <div class="flex items-center gap-2 text-sm text-muted mb-1">
                <a href="{{ route('admin.analisa-obligasi.index') }}" class="hover:text-primary">Monitor Analisa Obligasi</a>
                <span>/</span>
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            @endif
            <a href="{{ route('admin.analisa-obligasi.pdf', $analisa) }}" target="_blank"
    ...
    <div x-show="activeTab==='review'" class="space-y-4">
        ...
        <div class="bg-white rounded-xl border border-line p-6">
            ...
            <form method="POST" action="{{ route('admin.analisa-obligasi.review', $analisa) }}" class="space-y-4">
                @csrf
                <div>
