...
<div class="mb-5">
    <div class="flex items-center gap-1 bg-[#f1f5f9] rounded-xl p-1 w-fit">
        <a href="{{ route('admin.unit-link.index', ['tab' => 'unit-links']) }}"
        ...
        <a href="{{ route('admin.unit-link.index', ['tab' => 'unit-prices']) }}"
...
@if($tab === 'unit-links')
    @include('admin.unit-link._tab-unit-links')
@else
    @include('admin.unit-link._tab-unit-prices')
@endif
...
<div x-show="deleteId !== null" x-cloak
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6"
        ...
        <div class="flex items-center justify-end gap-3 mt-6">
            ...
            <form method="POST" :action="`/admin/unit-link/${deleteId}`">
                @csrf @method('DELETE')
