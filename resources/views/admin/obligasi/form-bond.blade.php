...
@section('title', isset($obligasi) ? 'Edit Obligasi Bond' : 'Tambah Obligasi Bond')
...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-primary">{{ isset($obligasi) ? 'Edit Obligasi Bond' : 'Tambah Obligasi Bond' }}</h1>
</div>
