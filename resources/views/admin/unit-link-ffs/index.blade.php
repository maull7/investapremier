...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-primary">Monitor Unit Link FFS</h1>
        <p class="text-muted text-sm mt-1">Unit Link yang disubmit user untuk dianalisa</p>
    </div>
</div>
    ...
    <div class="bg-white rounded-2xl border border-line overflow-hidden shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-line flex items-center justify-between bg-gradient-to-r from-primary to-primary-light">
            ...
            <div class="flex items-center gap-3">
                <span class="text-xs text-white/60">{{ $analisas->total() }} total</span>
                <button type="submit"
