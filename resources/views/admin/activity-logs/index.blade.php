    ...
    <form method="GET" class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 space-y-3">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
            <div>
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Aksi, keterangan, atau user..."
            ...
            <div>
                ...
                <select name="aksi" class="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
            ...
            <div>
                ...
                <select name="status" class="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
            ...
            <div>
                ...
                <select name="user_id" class="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <table class="min-w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                @empty
                    <tr><td colspan="6" class="px-4 py-8 text-center text-gray-400">Belum ada aktivitas.</td></tr>
                @endforelse
            </tbody>
        </table>
        @if($logs->hasPages())
