...
<body>
    ...
    <header class="nav">
        <div class="container nav-inner">
            ...
            <button id="ham" class="ham" aria-expanded="false" aria-label="Menu">
                <svg class="ic-open" viewBox="0 0 24 24">
                    <path d="M3 12h18" />
                    <path d="M3 6h18" />
                    <path d="M3 18h18" />
                </svg>
                <svg class="ic-close" viewBox="0 0 24 24">
                    <path d="M18 6 6 18" />
                    <path d="m6 6 12 12" />
                </svg>
            </button>
        ...
        <div class="container">
            <div class="hero-grid">
                <div>
                    ...
                    <p class="hero-sub">Kelola portofolio, proteksi, perencanaan, pajak, dan review advisor dalam satu
                        ekosistem digital yang elegan dan terstruktur.</p>
                ...
                <div class="dash-visual">
                    <div class="dash">
                        ...
                        <div class="dash-body">
                            <div class="dash-row">
                                <div class="dm">
                                    <div class="dm-l">Net Worth</div>
                                    <div class="dm-v">Rp 18,5 M</div>
                                </div>
                                <div class="dm">
                                    <div class="dm-l">Return YTD</div>
                                    <div class="dm-v g">+12,4%</div>
                                </div>
                                <div class="dm">
                                    <div class="dm-l">Investable</div>
                                    <div class="dm-v">Rp 11,2 M</div>
                                </div>
                                <div class="dm">
                                    <div class="dm-l">Likuiditas</div>
                                    <div class="dm-v">Rp 1,4 M</div>
                                </div>
                            </div>
                            <div class="alloc-title">Alokasi Aset</div>
                            <div class="abar">
                                <div class="abar-row"><span>Saham</span><span>30%</span></div>
                                <div class="abar-bg">
                                    <div class="abar-fill" style="width:30%"></div>
                                </div>
                            </div>
                            <div class="abar">
                                <div class="abar-row"><span>Obligasi</span><span>25%</span></div>
                                <div class="abar-bg">
                                    <div class="abar-fill" style="width:25%"></div>
                                </div>
                            </div>
                            <div class="abar">
                                <div class="abar-row"><span>Reksa Dana</span><span>20%</span></div>
                                <div class="abar-bg">
                                    <div class="abar-fill" style="width:20%"></div>
                                </div>
                            </div>
                            <div class="abar">
                                <div class="abar-row"><span>Unit Link</span><span>15%</span></div>
                                <div class="abar-bg">
                                    <div class="abar-fill" style="width:15%"></div>
                                </div>
                            </div>
                            <div class="abar">
                                <div class="abar-row"><span>Kas</span><span>10%</span></div>
                                <div class="abar-bg">
                                    <div class="abar-fill" style="width:10%"></div>
                                </div>
                            </div>
    ...
    <div class="ticker">
        <div class="ticker-track">
            @php $tks = [['n' => 'IHSG', 'v' => '7.284', 'c' => '+0,82%', 'u' => true], ['n' => 'ANTM', 'v' => '1.545', 'c' => '+2,13%', 'u' => true], ['n' => 'BBCA', 'v' => '9.225', 'c' => '-0,54%', 'u' => false], ['n' => 'TLKM', 'v' => '3.180', 'c' => '+1,26%', 'u' => true], ['n' => 'GOTO', 'v' => '68', 'c' => '+4,62%', 'u' => true], ['n' => 'FR0100', 'v' => '97,55', 'c' => '-0,18%', 'u' => false], ['n' => 'BMRI', 'v' => '6.075', 'c' => '+0,91%', 'u' => true], ['n' => 'ASII', 'v' => '4.890', 'c' => '-0,20%', 'u' => false], ['n' => 'UNVR', 'v' => '2.610', 'c' => '+1,56%', 'u' => true], ['n' => 'SBR013', 'v' => '100,12', 'c' => '+0,03%', 'u' => true]]; @endphp
            @foreach (array_merge($tks, $tks) as $t)
                <span class="ti">{{ $t['n'] }} <span class="tv">{{ $t['v'] }}</span><span
                        class="{{ $t['u'] ? 'tu' : 'td' }}">{{ $t['c'] }}</span></span>
            @endforeach
        </div>
    </div>
    ...
    <section id="fitur" class="sec">
        <div class="container">
            <div class="sec-head">
                ...
                <p>Investasi, proteksi, family planning, dan kolaborasi advisor — semua dalam satu ekosistem digital.
                </p>
            </div>
            <div class="feat-grid">
                <div class="feat">
                    ...
                    <p>Lihat seluruh aset, alokasi, likuiditas, dan progres investasi dalam satu dashboard premium yang
                        terstruktur.</p>
                </div>
                <div class="feat">
                    <div class="feat-icon"><svg viewBox="0 0 24 24">
                    ...
                    <p>Analisa laporan keuangan emiten, reksa dana, dan obligasi menggunakan AI dengan insight mendalam
                        dan akurat.</p>
                </div>
                <div class="feat">
                    <div class="feat-icon"><svg viewBox="0 0 24 24">
                    ...
                    <p>Rencanakan pendidikan, pensiun, dan legacy fund dengan target terukur dan progress tracking
                        otomatis.</p>
                </div>
                <div class="feat">
                    <div class="feat-icon"><svg viewBox="0 0 24 24">
                    ...
                    <p>Kelola polis asuransi, beneficiary, premi, dan gap proteksi untuk menjaga stabilitas finansial
                        keluarga.</p>
                </div>
                <div class="feat">
                    <div class="feat-icon"><svg viewBox="0 0 24 24">
                    ...
                    <p>Pantau kalender pajak, dokumen pendukung, dan tindak lanjut administratif keluarga secara
                        terstruktur.</p>
                </div>
                <div class="feat">
                    <div class="feat-icon"><svg viewBox="0 0 24 24">
                ...
                @foreach ($pricingPlans as $plan)
                    <div class="pricing-card {{ $plan['featured'] ? 'featured' : '' }}">
                        ...
                        <div class="mt-auto pt-4">
                            <button onclick="openPricingModal('{{ $plan['name'] }}')"
                                class="btn btn-green btn-sm w-full justify-center">
                                <svg viewBox="0 0 24 24">
                                    <path d="M5 12h14" />
                                    <path d="M12 5v14" />
                                </svg>
        ...
        <div class="container">
            ...
            <div class="steps-grid">
                <div class="step">
                    ...
                    <h3>Konsolidasikan Data</h3>
                    <p>Masukkan aset, tujuan, polis, beneficiary, dan dokumen ke satu sistem yang rapi.</p>
                </div>
                <div class="step">
                    <div class="step-num">2</div>
                    <h3>Pantau Progres & Risiko</h3>
                    <p>Lihat funding gap, jatuh tempo, dan kesiapan tujuan keluarga secara real-time.</p>
                </div>
                <div class="step">
                    <div class="step-num">3</div>
                    <h3>Analisa & Putuskan</h3>
                    <p>Gunakan AI Analysis dan data pasar untuk keputusan investasi yang lebih cerdas.</p>
                </div>
                <div class="step">
                    <div class="step-num">4</div>
                    <h3>Review Bersama Advisor</h3>
                    <p>Lakukan review terstruktur dan tindak lanjuti dalam satu platform terpadu.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            @php
                $gl = [
                    ...
                    [
                        'term' => 'Alpha',
                        'def' => 'Kinerja portofolio melebihi benchmark pasar. Alpha positif = return di atas pasar.',
                    ],
                    [
                        'term' => 'Beta',
                        'def' =>
                    ...
                    [
                        'term' => 'Portofolio',
                        'def' => 'Kumpulan instrumen investasi yang dimiliki untuk mencapai tujuan finansial tertentu.',
                    ],
                    [
                        'term' => 'Kupon Obligasi',
                        'def' =>
        ...
        <div class="container two-col">
            <div>
                <div class="sec-head" style="max-width:none">
                    ...
                    <p>Menangani data portofolio keluarga, beneficiary, dan dokumen advisory — keamanan adalah fondasi
                        utama kami.</p>
                </div>
                <div class="check-list">
                    @foreach (['Role-based access untuk client, advisor, household member, dan admin', 'Audit trail lengkap untuk login, akses dokumen, dan update data', 'Document vault dengan kontrol akses, histori versi, dan status dokumen', 'Notifikasi terstruktur untuk review, jatuh tempo, dan action plan', 'Data terenkripsi sesuai standar kepatuhan OJK'] as $c)
                        <div class="ci">
                            <div class="ci-dot"><svg viewBox="0 0 24 24">
                                    <path d="M20 6 9 17l-5-5" />
                                </svg></div>
                            <span>{{ $c }}</span>
                        </div>
        ...
        <div class="container">
            <div class="cta">
                <div class="cta-inner">
                    <div>
                        <span class="pill"
                            style="background:rgba(34,197,94,.15);border-color:rgba(34,197,94,.3);color:#4ade80">Mulai
                            Sekarang</span>
                        <h2>Bangun pengalaman wealth advisory yang lebih terintegrasi.</h2>
                        <p>Daftar gratis dan mulai kelola portofolio, analisa investasi, dan review advisor dalam satu
                            platform premium.</p>
                    </div>
                    <div class="cta-btns">
                        <a class="btn btn-green" href="{{ route('register') }}">
    ...
    <div id="pricingModal" class="modal-overlay" onclick="if(event.target===this)closePricingModal()">
        <div class="modal-box">
            ...
            <p>Fitur langganan <strong id="modal-plan-label"></strong> masih dalam tahap pengembangan. Kami akan
                memberitahu Anda begitu tersedia!</p>
