...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hamburger.is-open .menu-icon-open {
            display: none
        }

        .hamburger.is-open .menu-icon-close {
            display: block
        }
    ...
    <header class="nav">
        <div class="container nav-inner">
            ...
            <nav id="site-menu" class="menu">
                <a href="#fitur" data-menu-link>Fitur</a>
                <a href="#modul" data-menu-link>Modul</a>
                <a href="#untuk-siapa" data-menu-link>Untuk Siapa</a>
                <a href="#alur" data-menu-link>Alur</a>
                <a href="#keamanan" data-menu-link>Keamanan</a>
