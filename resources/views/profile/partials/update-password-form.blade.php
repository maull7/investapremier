<form method="post" action="{{ route('password.update') }}" class="space-y-5">
    ...
    <div>
        ...
        <x-text-input id="update_password_current_password" name="current_password" type="password"
            ...
            class="w-full px-3 py-2 text-sm @error('current_password', 'updatePassword') border-accent-teal/85 @enderror" />
    ...
    <div>
        ...
        <x-text-input id="update_password_password" name="password" type="password" autocomplete="new-password"
            class="w-full px-3 py-2 text-sm @error('password', 'updatePassword') border-accent-teal/85 @enderror" />
    ...
    <div>
        ...
        <x-text-input id="update_password_password_confirmation" name="password_confirmation" type="password"
            ...
            class="w-full px-3 py-2 text-sm @error('password_confirmation', 'updatePassword') border-accent-teal/85 @enderror" />
