            ...
            <nav class="flex-1 py-4 px-3 space-y-1 text-sm overflow-y-auto">
                ...
                <div>
                    <button type="button" @click="obligasiOpen = !obligasiOpen"
                        class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.obligasi.*') || request()->routeIs('admin.analisa-obligasi.*') || request()->routeIs('admin.rating-obligasi.*') || request()->routeIs('admin.ytm-normal-curve.*') ? 'bg-white/10 font-semibold' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
                        <span class="flex items-center gap-3">
                    ...
                    <div x-show="obligasiOpen" x-transition class="space-y-1 pl-3">
                        ...
                        <a href="{{ route('admin.rating-obligasi.index') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.rating-obligasi.*') ? 'bg-white/10 font-semibold text-white' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
                        ...
                        <a href="{{ route('admin.ytm-normal-curve.index') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.ytm-normal-curve.*') ? 'bg-white/10 font-semibold text-white' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
                ...
                <a href="{{ route("admin.investment-managers.index") }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs("admin.investment-managers.*") ? "bg-white/10 font-semibold text-white" : "text-white/70 hover:bg-white/5 hover:text-white" }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.daftar-reksa-dana.index') }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('admin.daftar-reksa-dana.*') || request()->routeIs('admin.data-source-links.*') ? 'bg-white/10 font-semibold text-white' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
                    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
