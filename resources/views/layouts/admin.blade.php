...
@section('body')
    <div x-data="{
        ...
        {{-- Sidebar Desktop --}}
        <aside x-data
            :class="sidebarCollapsed ? 'w-[68px] sidebar-collapsed' : 'w-64'"
            ...
            <div class="h-16 flex items-center gap-3 px-3 border-b border-green-500/10">
                ...
                <button @@click="sidebarCollapsed = !sidebarCollapsed"
                    ...
                    <svg x-show="!sidebarCollapsed" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 19l-7-7 7-7m8 14l-7-7 7-7"/>
                    </svg>
                    <svg x-show="sidebarCollapsed" x-cloak class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
