...
class AnalisaReksaDana extends Model
{
    ...
    protected $fillable = [
        ...
        'jenis_laporan', 'periode_awal', 'periode_akhir', 'tahun_laporan',
        'total_return', 'biaya_operasi', 'portfolio_turnover_ratio', 'management_fee', 'custodian_fee',
        'total_aset', 'total_liabilitas', 'kas_dan_bank', 'piutang_bunga', 'piutang_dividen',
        'piutang_lain', 'utang_pajak', 'utang_lain',
