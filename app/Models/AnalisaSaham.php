...
class AnalisaSaham extends Model
{
    ...
    protected $casts = [
        'periode_dari' => 'integer',
        'periode_sampai' => 'integer',
        'jumlah_lembar_saham' => 'decimal:2',
        'harga_saham' => 'decimal:2',
        'q1_saham' => 'decimal:2',
        'q2_saham' => 'decimal:2',
        'q3_saham' => 'decimal:2',
        'q4_saham' => 'decimal:2',
        'kapitalisasi_pasar' => 'decimal:2',
        ...
        'likuiditas_data' => 'array',
        'keuangan_data' => 'array',
        'portofolio_data' => 'array',
        'saham_pembanding_data' => 'array',
    ];
